...
import TopicsDrafts from '../components/cruds/Topics/Drafts.vue'
...
const routes = [
    ...
    { path: '/topics/drafts', component: TopicsDrafts, name: 'topics.drafts' },
    { path: '/topics/create', component: TopicsCreate, name: 'topics.create' },
